class Championship < ActiveRecord::Base
  ...
  def championship_data
    Championship.find_by_sql("select pr.number, p.full_name, p.city, p.team,  p.car, SUM (rr.score_for_champ) as score
        ...
        group by rr.pilot_id, p.full_name, pr.number, p.team, p.city, p.car
